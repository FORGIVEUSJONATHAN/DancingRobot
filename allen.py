...
if __name__ == '__main__':
	...
	try:
		# execute sequence for Allen
		console_log("Going to target point (using RRT)")
		execute_path(calculate_path(robot_postion, target_position))
		console_log("Reached target point! going back to origin with new path...")
		execute_path(calculate_path(target_position, robot_postion))
		console_log("Done!! Stopping node...")
